...
SRC :=	free.c dup.c print.c \
        ...
        modified/modified_lst_func.c modified/modified_strjoin_func.c modified/modified_strjoin_nocheck.c modified/modified_get_env.c modified/new_mod_split.c\
        main.c \
		signals.c \
		signals_two.c \
		executer/execute.c \

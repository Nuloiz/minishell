...
SRC :=	free.c dup.c print.c \
        parser/input_sort.c parser/input_type.c parser/input_type_strncmp.c parser/new_quotes.c parser/quotes.c parser/env_var.c parser/create_array.c parser/fill_tmp.c parser/error_msg.c parser/get_commands.c \

...
SRC :=	free.c dup.c print.c \
        ...
        modified/modified_lst_func.c modified/modified_split_func.c modified/modified_split_func_two.c modified/modified_strjoin_func.c modified/modified_get_env.c modified/modified_substr_func.c\
        main.c \
		executer/execute.c \
